...
(custom-theme-set-faces
 ...
 '(default ((t (:background "#191970" :foreground "#F8F8F2"))))
 ...
 '(mode-line-buffer-id ((t (:freground nil :background nil))))
 ...
 ;; 関数名
 '(font-lock-function-name-face ((t (:foreground "#FF8C00"))))
 ...
 ;; 属性
 '(nxml-attribute-name ((t (:foreground "#66D9EF"))))
 ;; 括弧
